...
<div class="card mb-3">
          <div class="card-header">
            ...
            Tambah Data Artikel</div>
          <div class="card-body">
            <div class="table-responsive">
<form role="form" method="post" action="artikel/proses_tambah.php" name="forminputfas" id="forminputfas" enctype="multipart/form-data">
<table width="650">

<tr><td height="15"></td></tr>
<tr>

	<td width="230" height="30">&nbsp;&nbsp;<label>Judul Artikel</label></td>
    <td width="400"><input type="text" name="nama" id="nama" size="50" class="form-control" placeholder="Masukkan Nama Artikel"/></td>
    <td width="15"></td>
</tr>
<!-- <tr><td height="15"></td></tr>
<tr>
...
<tr><td height="15"></td></tr>
<tr>
    <td width="200" height="30">&nbsp;&nbsp;<label>Isi Artikel</label></td>
    <td width="306"><textarea class="form-control" name="ket" cols="25" rows="5"></textarea></td>
    <td width="15"></td>
</tr>
<tr><td height="15"></td></tr>
<tr>
    <td height="24">&nbsp;&nbsp;<label>Foto Artikel</label></td>
