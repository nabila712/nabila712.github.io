...
<form role="form" method="post" action="pelayanan/proses_tambah.php" name="forminputfas" id="forminputfas" enctype="multipart/form-data">
<table width="650">

<tr><td height="15"></td></tr>
<tr>

	<td width="230" height="30">&nbsp;&nbsp;<label>Nama Pelayanan</label></td>
    <td width="400"><input type="text" name="nama" id="nama" size="50" class="form-control" placeholder="Masukkan Nama Pelayanan"/></td>
    <td width="15"></td>
</tr>
<!-- <tr><td height="15"></td></tr>
<tr>
...
<tr><td height="15"></td></tr>
<tr>
    <td height="24">&nbsp;&nbsp;<label>Foto Pelayanan</label></td>
